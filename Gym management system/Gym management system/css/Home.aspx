<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Home.aspx.vb" Inherits="Gym_managment_system.Home" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
<head runat="server">
<title> Gym Workout a Sports Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
	
	<link href="style.css" rel="stylesheet" />
	<link href="bootstrap.css" rel="stylesheet" />
	<link href="cm-overlay.css" rel="stylesheet" />
						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav navbar-right">
									...
									<li> <div class="read-w3ls">
		<a class="member-btn-agileits page-scroll" href="#myModal2" data-toggle="modal" data-hover="LOGIN">LOGIN</a>
	</div>
</div>
<!-- modal -->
			...
			<div class="modal-content">
				...
				<div class="modal-body login-page "><!-- login-page -->     
									<div class="login-top sign-top">
										...
										<h5>gym login form</h5>
										<form action="#"  method="post">
										
											<h6>Personal Details</h6>
											<input type="text" name="Name1" placeholder="Username" required=""/>
											<input type="password" name="Email1" placeholder="Password" required=""/>
...
<div data-target="clients" class="clients" id="clients">
	...
	<div class="w3agile-spldishes">
		<div class="container">
			...
			<p class="para-agileits-w3layouts">Aliquam in dolor eu ipsum elementum auctor vitae eget felis. Integer feugiat rutrum accumsan. Donec velit eros, eleifend vitae nisi nec, mattis auctor dui. Aliquam erat volutpat Neque porro quisquam est qui dolorem Lorem ipsum dolor sit amet.</p>
