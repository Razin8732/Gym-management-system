<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="Gym_managment_system.Home" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
<head runat="server">
<title> Gym Management System | Home :: w3layouts</title>
...
<div class="footer-w3layouts">
				...
				<div class="agile-copy">
					<p>© 2019 Gym Workout. All rights reserved | Design By Razin Shaikh</p>
				</div>
				<div class="agileits-social">
					<ul>
							<li><a href="#"><i class="fa fa-facebook"></i></a></li>
